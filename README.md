# Hi, I'm Shaswat Agarwal 👋

**Senior Data Engineer** | Azure · Databricks · Delta Lake · DevOps  
📍 Kolkata, India &nbsp;|&nbsp; 📧 shaswat1404@gmail.com &nbsp;|&nbsp; 🔗 [LinkedIn](https://www.linkedin.com/in/shaswat-agarwal-81ba76195)

---

## About Me

I build data platforms that scale — from raw ingestion to business-ready gold tables.  
Over the past 2+ years I've worked across **Real Estate, Senior Housing, and Fashion** verticals, delivering end-to-end solutions on the Azure ecosystem.

My focus areas:
- Designing **medallion lakehouse architectures** (Bronze → Silver → Gold) on Azure Databricks
- Building robust **ETL/ELT pipelines** with ADF, PySpark, and Delta Live Tables
- Migrating legacy systems to **modern, cost-optimised** cloud platforms
- Enabling **DevOps and governance** (Unity Catalog, CI/CD, Key Vault) for production Databricks workspaces

When I'm not building pipelines, I'm thinking about data quality, cost efficiency, and making infrastructure invisible to the teams that depend on it.
